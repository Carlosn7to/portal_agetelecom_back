    ...
    <tr>
        <td align="center">
            <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFDF9">
                <tr id="header">
                    <td
                        style="background: url('https://agenotifica.s3.sa-east-1.amazonaws.com/age/boasVindas/Grupo+98.png') no-repeat center; background-size: cover; height: 400px; padding: 0; margin: 0;">
                        ...
                        <table style="margin: 0 auto;">
                            <tr>
                                <td style="text-align: center;">
                                    <p style="margin: 0; color: #000000; font-size: 32px;">Você pode ganhar <b
                                            style="color: #FF7200;">R$ 10 de</b>
                                    </p>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td
                                    style="font-size: 15px; padding: 0 45px 10px 45px; text-align: center; line-height: 1.5; background: #ffffff; border: 1px solid #ffffff; border-radius: 0 0 25px 25px; margin: 0;">
                                        <span style="font-size: 32px; font-weight: 500; color: #000000;"><b
                                                style="color: #FF7200;">desconto</b> na sua fatura!</span>
                                    <p>Que tal ter mais economia para você aproveitar o que
                                        realmente importa?
                                    </p>
                                    <img src="https://agenotifica.s3.sa-east-1.amazonaws.com/age/boasVindas/Imagem+7.png"
                                         alt="">
                                    <p>Se você tiver conta na Caixa ou no Santander e colocar a <b>fatura em débito
                                            automático ou como recorrência no cartão de crédito,</b> além de
                                        praticidade e
                                        comodidade para curtir e navegar sem preocupações, <b
                                            style="color: #FF7200;">você ganha R$10 de
                                            desconto na fatura!</b>
                                    </p>
                                    <p>
                                        Para qualquer dúvida, <b>conte sempre com nossos canais de atendimento clicando
                                            nos ícones abaixo!</b>
                                    </p>
                                    <table width="575">
                                        <tr>
