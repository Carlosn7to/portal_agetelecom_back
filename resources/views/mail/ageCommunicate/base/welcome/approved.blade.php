    ...
    <tr>
        <td align="center">
            <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFDF9">
                <tr id="header">
                    <td
                        style="background: url('https://agenotifica.s3.sa-east-1.amazonaws.com/age/boasVindas/Grupo+85.png') no-repeat center; background-size: cover; height: 400px; padding: 0; margin: 0;">
                        ...
                        <table style="margin: 0 auto;">
                            <tr>
                                <td style="text-align: center;">
                                    <p style="margin: 0; color: #000000; font-size: 32px;">Seja bem-vindo à</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="body">
                    <td align="center" style="padding: 0; margin: 0;">
                        <table width="575" style="padding: 0; margin: 0;">
                            <tr>
                                <td
                                    style="font-size: 15px; padding: 0 45px 10px 45px; text-align: center; line-height: 1.5; background: #ffffff; border: 1px solid #ffffff; border-radius: 25px; margin: 0;">
                                        <span style="font-size: 32px; font-weight: 500;"><b style="color: #FF7200;">Age
                                                Telecom!</b></span>
                                    <p>Olá, {{ mb_convert_case($data->nameclient, MB_CASE_TITLE, 'UTF-8')  }}</p>
                                    <p>É com <b>grande satisfação que recebemos você </b> na AGE Telecom!



                                    </p>
                                    <p><b>Agradecemos a sua confiança e reforçamos nosso comprometimento</b> em
                                        levar nosso
                                        melhor serviço para dentro da sua casa. Temos certeza de que <b>juntos
                                            viveremos momentos incríveis e de muita conexão.</b>




                                    </p>
                                    <p>Para qualquer dúvida, <b>conte sempre com nossos canais de atendimento
                                            clicando
                                            nos ícones abaixo!</b>
                                    </p>
                                </td>
                            ...
                            <tr>
                                <td align="center" style="padding: 5px 0;">
                                        <span>Atenciosamente,<br><b style="color: #FF7200; font-weight: 700;">Time Age
                                                Telecom</b></span>
                                </td>
                            </tr>
                        </table>
