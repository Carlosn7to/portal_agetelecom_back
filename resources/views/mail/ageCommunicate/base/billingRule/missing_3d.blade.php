...
<div class="container">
    <header>
        <img src="https://agenotifica.s3.sa-east-1.amazonaws.com/age/emailAssets/Cabe%C3%A7alho-Regua-de-Cobran%C3%A7a.png"
             alt="Header Image" class="imgHeader">
    </header>
    <main class="mainContent">
        <section class="mainTitle">
            <h1 style="color: #03257E; text-align: start">Olá, {{$name_client}}</h1>
        </section>
        <section>
            <div class="content">
                <div style="text-align: justify; font-weight: 500;">
                    <p>Passando para lembrar que o vencimento do seu boleto está se aproximando. Restam apenas
                        <b>03 dias</b> para efetuar o pagamento e evitar juros e multa por atraso.
                    </p>
                    <p>Não perca o desconto de pontualidade e efetue o pagamento da sua fatura até a data de
                        vencimento. Aproveite ao máximo da nossa internet e continue em dia com suas séries,
                        vídeos e filmes favoritos.</p>
                </div>
