...
<div class="container">
    ...
    <main class="mainContent">
        <section class="mainTitle">
            <h1 style="color: #E60201; text-align: start">Olá, {{$data->name_client}}</h1>
        </section>
        <section>
            <div class="content">
                <div style="text-align: justify; font-weight: 500;">
                    <p>Informamos que o seu débito se encontra com mais de <b>80 dias de atraso</b>, o que nos leva
                        a
